...
The project's [Github Pages site](https://usegpu.mentat.org) hosts an
...
This will ship the site to https://usegpu.mentat.org.

## Publishing to Clojars

The template for the project's `pom.xml` lives at
[`template/pom.xml`](https://github.com/mentat-collective/usegpu.cljs/blob/main/template/pom.xml).

To create a new release:

- Update the version in
  [build.clj](https://github.com/mentat-collective/usegpu.cljs/blob/main/build.clj)
- Make a new [Github
  Release](https://github.com/mentat-collective/usegpu.cljs/releases) with tag
  `v<the-new-version>`.
